    ...
    if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.Administrator)) {
        ...
        if (canal_formulario.type !== Discord.ChannelType.GuildText) {
            ...
            interaction.reply({ embeds: [embed], ephemeral: true }).then( () => {
                ...
                .setDescription(`**Nosso servidor possui uma Allowlist séria...** 
                
                Pessoas menores de 14 anos estarão sujeitas a entrevista com nossa equipe de *Whitelist Managers*.

                Ciente disso, para realizar sua allowlist, clique no botão a baixo.`)
                .setImage("https://cdn.discordapp.com/attachments/998014459824054272/1122986829415723150/allowlist.png");
